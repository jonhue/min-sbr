...
\begin{proof}[Proof (cont.)]
To show: $k+l+m-v \geq \frac{c_2(\pi)}{2}$. \pause We know that
\begin{enumerate}
...
\begin{block}{Summary}
\begin{itemize}
    \item the number of alternating cycles in a breakpoint graph $G(\pi)$ are related to $d(\pi)$
